...
const syncPriority: Record<StoreName, number> = {
  ...
  usuarioEquipes: 3,
  parcelas: 4,
  parcelasPlanejadas: 5,
  avaliacoes: 6,
  avaliacaoColaboradores: 7,
  avaliacaoParcelas: 8,
  avaliacaoRuas: 9,
  avaliacaoRetoques: 10,
  producoes: 11,
  avaliacaoLogs: 12,
  registrosColeta: 13,
  atribuicoesRetoque: 14,
  notificacoes: 15,
  tentativasLogin: 16,
  configuracoes: 17,
  syncLogs: 18,
...
const remoteFieldsByStore: Partial<Record<StoreName, string[]>> = {
  ...
  avaliacoes: [
    ...
    'retoqueDesignadoParaIds',
    'retoqueDesignadoParaNomes',
    'totalRegistros',
    'mediaParcela',
    'mediaCachos3',
    'origemDado',
...
const SYNC_STORE_LABELS: Partial<Record<StoreName, string>> = {
  ...
  avaliacaoRetoques: 'retoques da avalia\u00e7\u00e3o',
  producoes: 'produ\u00e7\u00e3o',
...
> = {
  ...
  usuarioEquipes: (record) =>
    `${String(record.usuarioId || '').trim()}:${String(record.equipeId || '').trim()}`,
  equipes: (record) => String(record.numero ?? '').trim(),
  parcelas: (record) => String(record.codigo || '').trim().toUpperCase(),
  parcelasPlanejadas: (record) =>
    [
      String(record.codigo || '').trim().toUpperCase(),
      String(record.equipeId || '').trim(),
      String(record.dataColheita || '').trim(),
    ].join(':'),
  dispositivos: (record) =>
  ...
  avaliacaoRetoques: (record) =>
    String(record.avaliacaoId || '').trim(),
  producoes: (record) =>
    [
      String(record.avaliacaoId || '').trim(),
      String(record.retoqueId || '').trim(),
      String(record.data || '').trim(),
      String(record.equipeId || record.equipeNome || '').trim(),
    ].join(':'),
  atribuicoesRetoque: (record) =>
    `${String(record.avaliacaoId || '').trim()}:${String(record.usuarioId || '').trim()}`,
  notificacoes: (record) =>
    [
      String(record.usuarioId || '').trim(),
      String(record.tipo || '').trim(),
      String(record.referenciaId || '').trim(),
    ].join(':'),
};
...
> = {
  colaboradores: [
    ...
    { storeName: 'avaliacoes', field: 'responsavelPrincipalId' },
    { storeName: 'avaliacoes', field: 'encerradoPorId' },
    { storeName: 'avaliacoes', field: 'marcadoRetoquePorId' },
    { storeName: 'avaliacoes', field: 'retoqueDesignadoParaId' },
    { storeName: 'avaliacaoColaboradores', field: 'colaboradorId' },
    { storeName: 'avaliacaoRetoques', field: 'responsavelId' },
    { storeName: 'avaliacaoRetoques', field: 'finalizadoPorId' },
    { storeName: 'usuarioEquipes', field: 'usuarioId' },
    { storeName: 'avaliacaoLogs', field: 'colaboradorId' },
    { storeName: 'registrosColeta', field: 'colaboradorId' },
    { storeName: 'tentativasLogin', field: 'colaboradorId' },
    { storeName: 'parcelasPlanejadas', field: 'criadoPor' },
    { storeName: 'notificacoes', field: 'usuarioId' },
    { storeName: 'atribuicoesRetoque', field: 'usuarioId' },
    { storeName: 'atribuicoesRetoque', field: 'atribuidoPor' },
  ],
  avaliacoes: [
    { storeName: 'avaliacaoColaboradores', field: 'avaliacaoId' },
    { storeName: 'avaliacaoParcelas', field: 'avaliacaoId' },
    { storeName: 'avaliacaoRuas', field: 'avaliacaoId' },
    { storeName: 'registrosColeta', field: 'avaliacaoId' },
    { storeName: 'avaliacaoRetoques', field: 'avaliacaoId' },
    { storeName: 'avaliacaoRetoques', field: 'avaliacaoOriginalId' },
    { storeName: 'producoes', field: 'avaliacaoId' },
    { storeName: 'avaliacaoLogs', field: 'avaliacaoId' },
    { storeName: 'parcelasPlanejadas', field: 'avaliacaoId' },
    { storeName: 'atribuicoesRetoque', field: 'avaliacaoId' },
  ],
  equipes: [
    { storeName: 'usuarioEquipes', field: 'equipeId' },
    { storeName: 'avaliacoes', field: 'equipeId' },
    { storeName: 'avaliacaoRuas', field: 'equipeId' },
    { storeName: 'avaliacaoRetoques', field: 'equipeId' },
    { storeName: 'producoes', field: 'equipeId' },
    { storeName: 'parcelasPlanejadas', field: 'equipeId' },
    { storeName: 'notificacoes', field: 'equipeId' },
    { storeName: 'atribuicoesRetoque', field: 'equipeId' },
  ],
  parcelas: [
    ...
    { storeName: 'parcelasPlanejadas', field: 'parcelaId' },
    { storeName: 'atribuicoesRetoque', field: 'parcelaId' },
  ],
  dispositivos: [
  ...
  avaliacaoRetoques: [{ storeName: 'producoes', field: 'retoqueId' }],
};
